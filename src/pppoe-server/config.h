...
/* Define if RFC 4938 should be supported */
#define SUPPORT_RFC4938 1
...
#define PPPOE_PATH               "pppoe"
#define PPPD_PATH                "/usr/sbin/pppd"
#define PPP_IPV6_UP_PATH         "/ppp/ipv6-up.d"
#define PPP_IPV4_UP_PATH         "/ppp/ip-up.d"
#define PPP_IPV4_DOWN_PATH       "/ppp/ip-down.d"
#define PLUGIN_PATH              "/ppp/plugins"
#define PPPOESERVER_PPPD_OPTIONS "/etc/ppp/pppoe-server-options"
#define PPPOE_SERVER_OPTIONS     PPPOESERVER_PPPD_OPTIONS
